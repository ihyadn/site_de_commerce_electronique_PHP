                ...
                <div class="col-md-4">
                    ...
                    <div class="container-fluid" id="main">
                        <div class="row row-offcanvas row-offcanvas-left vh-100">
                            <div class="col-md-3 col-lg-3 sidebar-offcanvas h-100 overflow-auto bg-light pl-0"
                  ...
                  {?>
                        <div class="ml-5 mb-5 d-flex">
                            <img src="<?php echo $product["image"];?>"
                                class=" col-md-3 mr-5 ml-5 w-75 h-75 "><br /><br />
                            <form method="post" class="d-flex flex-column justify-content-between col-md-8 ">
                                ...
                                <input type="text" name="quantity" class="form-control" value="1"
                                    id="<?php echo "quantity".$product["ref"];?>">
                                <input type="hidden" name="name" value="<?php echo $product["name"];?>"
                                    id="<?php echo "name".$product["ref"];?>">
                                <input type="hidden" name="type" value="<?php echo $product["type"];?>"
                                    id="<?php echo "type".$product["ref"];?>">
                                <input type="hidden" name="price" value="<?php echo $product["price"];?>"
                                    id="<?php echo "price".$product["ref"];?>">
                                <input type="hidden" name="shipping" value="<?php echo $product["shipping"];?>"
                                    id="<?php echo "shipping".$product["ref"];?>">
                                <input action="add" type="submit" id=<?php echo $product["ref"]?> name="add_to_carte"
                                    class="btn btn-success flex-end add_cart" value="Add to Carte">
                            </form>
                        </div>
                        <?php
                  }
